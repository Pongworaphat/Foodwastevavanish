...
export default function SettingsPage() {
  ...
  useEffect(() => {
    // โหลดค่าตั้งค่าจาก localStorage ตัวอย่าง (จะเปลี่ยนเป็นเรียก API ในโปรดักชัน)
    try {
  ...
  function handlePasswordSubmit(e) {
    ...
    // TODO: เรียก API เปลี่ยนรหัสผ่านที่นี่ (fetch/axios)
  ...
  function handlePrefsSave() {
    ...
    // เก็บตัวอย่างใน localStorage — เปลี่ยนเป็นเรียก API ได้
